...
/*
    ...
    style="display: block;">
      <div class="com-table-main">
        ...
        //每一个评论
        <div class="comments-item" >					//div3
          <div class="com-item-main clearfix">			//div4
				<div class="column column1">
				  <div class="user-name">					//div6
					振***具
				  </div>
				  <div class="comment-time type-item">		//div8
					2016-01-16 18:19
				  </div>
				  <div class="features type-item">			//div9
					金夹
				  </div>
				</div>
				<div class="column column2">				//div10
				  <div class="p-comment">					//div11
					哎比较高档大气上档次
				  </div>
				</div>
          </div>
