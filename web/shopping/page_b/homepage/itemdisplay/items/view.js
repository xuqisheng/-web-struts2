...
img2.setAttribute("width","30");//危化品标识
...
if (data!=null&&data!=undefined) {
	...
	for (var i=0;i<data.length;i++) {
		...
		// 这里需要改成利用平台的fileSystem_getImgStreamAction.action?seq="+data+"&type="+fileObj.type+"&projid="+$.getProjID() 作为图片路径。相应的DAO需要修改。
		//data[i].itemimgupload中获取seq
		...
		if (final_num == 223){//易爆
			img2.setAttribute("src","/img/tocix.jpg")
		}
		if (final_num == 224){//剧毒
			img2.setAttribute("src","/img/tocix.jpg")
		}
		...
		strong3.innerHTML = "    <a   href='#'>"+data[i].itempara["0"]+"</a><img width='16' height='16' src='./img/qq.png'/>";
		tmp+=li1.outerHTML;
	}
	ul1.innerHTML = tmp;
	out = ul1.outerHTML;
