...
/*var tail1 = '<div id="cart-floatbar"><div class="cart-toolbar" style="width: 988px; height: 50px;"><div class="toolbar-wrap"><div class="options-box"><div class="toolbar-right"><div class="normal"><div class="comm-right"><div class="btn-area"> <a href="addOrder.action" onclick="window.close()" class="submit-btn">去结算<b></b></a></div><div class="price-sum"><div><span class="txt">总价：</span><span class="price sumPrice"><em id="total">';
*/

/**by 吴斌  
修改去结算
删除 href="addOrder.action" onclick="window.close()"
增加页面跳转
**/
var tail1 = '<div id="cart-floatbar"><div class="cart-toolbar" style="width: 988px; height: 50px;"><div class="toolbar-wrap"><div class="options-box"><div class="toolbar-right"><div class="normal"><div class="comm-right"><div class="btn-area"> '+
			'<a onclick="nexttosettle()" class="submit-btn">去结算<b></b></a></div><div class="price-sum"><div><span class="txt">总价：</span><span class="price sumPrice"><em id="total">';
...
a3.innerHTML="删除";
a4.setAttribute("class","cart-remove");
a4.setAttribute("href","#");
a4.innerHTML="到货通知";
a5.setAttribute("class","cart-remove");
a5.setAttribute("href","#");
a5.innerHTML="移到我的关注";
a6.setAttribute("class","cart-remove");
a6.setAttribute("href","#");
a6.innerHTML="加到我的关注";
a7.setAttribute("id","minus");
a7.setAttribute("data-num","-1");
a7.setAttribute("data-tpa","DECREMENT");
a7.setAttribute("href","javascript:;");
a7.setAttribute("class","minus");
a7.innerHTML="-";
input1.setAttribute("id","vals");
input1.setAttribute("type","text");
input1.setAttribute("class","itxt");



a8.setAttribute("id","add");
a8.setAttribute("data-num","1");
a8.setAttribute("data-tpa","INCREMENT");
a8.setAttribute("href","javascript:;");
a8.setAttribute("class","add");
a8.innerHTML="+";
img1.setAttribute("width","80");
img1.setAttribute("height","80");
img1.setAttribute("onerror", "this.src='img/default.jpg'");
input2.setAttribute("id","chkb");
...
div17.appendChild(a7);
div17.appendChild(input1);

div17.appendChild(a8);
div14.appendChild(div17);
div15.appendChild(strong2);
div16.appendChild(a3);
div16.appendChild(a4);
div16.appendChild(a5);
div16.appendChild(a6);
...
if (data!=null&&data!=undefined) {
	...
	for (var i=0;i<data.length;i++) {
		...
		var itemImgUpload = data[i].itemimgupload;//modify
		a1.setAttribute("href","item.jsp?itemid="+parents+"&subid="+data[i].itemid+"&projid="+projID);//modify 
		...
		a2.setAttribute("href","item.jsp?itemid="+parents+"&subid="+data[i].itemid+"&projid="+projID);//modify
...
//		a2.setAttribute("href","item.jsp?itemid="+data[i].itemid+"&projid="+projID);
		...
		div12.innerHTML = data[i].itempara[0];
		strong1.innerHTML = (data[i].prize-0).toFixed(2);
		strong1.setAttribute("id","prize-"+data[i].cartid);
		input1.setAttribute("value",data[i].number);
		input1.setAttribute("cart",data[i].cartid);
		strong2.innerHTML = ((data[i].prize-0)*data[i].number).toFixed(2);
		strong2.setAttribute("id","sum-"+data[i].cartid);
		sum = sum+(data[i].prize-0)*data[i].number;
		a3.setAttribute("href","deleteCart.action?cartid="+data[i].cartid);
		a9.innerHTML = data[i].itemname;
		input2.setAttribute("value",data[i].cartid);
		input2.setAttribute("itemcate",data[i].itemcate);
		list+=div4.outerHTML;
	}
	div3.innerHTML = list;
	out = div1.outerHTML;
