...
//           </strong>
//         </div>
//         <div class="p-operate">   //div6
//           <a class="p-o-btn addcart" href="#" target="_blank">
//			<i></i>
//             加入购物车
//           </a>
//			<a class="p-o-btn addcollection" href="#" target="_blank">
//			<i></i>
//             加入收藏
//           </a>
//         </div>
...
a4.setAttribute("class","p-o-btn addcollection");
a4.innerHTML = "<i></i>添加收藏";
/*  结束  */
a1.appendChild(img1);
div2.appendChild(a1);
...
if (data!=null&&data!=undefined) {
	...
	for (var i=0;i<data.length;i++) {
		...
		a3.setAttribute("onclick","addcard(\""+data[i].itemid+"\",1)");
