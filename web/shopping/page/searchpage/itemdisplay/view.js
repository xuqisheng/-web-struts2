...
if(value.indexOf(",")>0){
	...
	for(var i = 0; i<valueArray.length;i++){
		...
		i2.setAttribute("class","crumbs-first-del");
		i2.innerHTML = " X";
		span.setAttribute("class","crumbs-first-span");
		span.innerHTML =valueArray[i]+i2.outerHTML;
		div5.innerHTML += span.outerHTML;
	}
}else if(value != "全部结果"){
	//只有一个搜索条件，不含“，”
	var span = document.createElement("span");
	...
	var i2 = document.createElement('i');
		i2.setAttribute("class","crumbs-first-del");
		i2.innerHTML = " X";
	span.innerHTML = value +i2.outerHTML;
	div5.innerHTML += span.outerHTML;
}
//结束
//搜索关键字总体显示
