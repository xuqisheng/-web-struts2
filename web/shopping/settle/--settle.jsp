			   ...
			   <div id="content_list">
				  <div class="showlist" id="two">
				     <table class="table_style" border="0" id="table_test">
				            <tr >
				             <th class="table_th" style="font-weight:normal;text-align: left;">支付项目<select id="pro" name="pro" onChange="projchange(this)">
				                     <option value="0">==请选择支付项目==</option>
				                </select><span>项目金额<input type="text" style="width:64px;"></span><span>
				                        <span id="proinfo" style="display: inline;">项目负责人：黄先开；项目余额：163341.3</span>
				                        <span style="display:none;" id="proid">81131431403</span><!--项目-->
				                        <span style="display:none;" id="chargecode"></span><!--项目负责人编号-->           
				                        <span style="display:none;" id="chargename">黄先开</span><!--项目负责人名字-->                            
				                    <!-- <span id="add">+</span> -->
...
$(function(){
	...
	$("#add").click(function(){
		...
		$("#list1").append('<tr><td><span class="view_details">支付项目<select  name="pro" onChange="projchange(this)">'+select_html+'</select></span><span>项目金额<input type="text" style="width:64px;"></span> <span id="proinfo" style="display: inline;">项目负责人：黄先开；项目余额：163341.3</span> <span style="display:none;" id="proid">81131431403</span><span style="display:none;" id="chargecode"></span><span style="display:none;" id="chargename">黄先开</span><span class="add_myclass" id="display"  onclick="deleteTr(this)"><img src="./images/close.png"/style="vertical-align:middle; margin-bottom:5px;cursor: pointer;width:22px; height:22px;"></span>'+'</td></tr>');
		i++;
