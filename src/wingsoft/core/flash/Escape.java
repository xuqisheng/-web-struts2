...
public class Escape {
	// escape first
	// and then replace %u with --unicode
	public static String escapeThenEncode(String s) {
		String result = s;

		// % is represented as %25 when escaped
		result = result.replaceAll("%", "__pe");
		result = result.replaceAll("\\+", "__pl");
		result = result.replaceAll("\\:", "__c");
		result = result.replaceAll("\\*", "__s");

		result = escape(result);

		result = result.replaceAll("%u", "__u");

		System.out.println("escapeThenEncode: result is " + result);

		return result;
	}

	// replace --colon with :
	// and replace --unicode with %u
	// then we begin to unescape
	public static String decodeThenUnescape(String s) {
		String result = s;
		result = result.replaceAll("__u", "%u");
		...
		System.out.println("decodeThenUnescape: result is " + result);
	...
	public static void main(String[] args) {
		/*
		 * String stest = "1234 abcd[]()<+>,.~\\"; System.out.println(stest);
		 * System.out.println(escape(stest));
		 * System.out.println(unescape(escape(stest)));
		 */

		// System.out.println(unescapeWithoutPercent("56FE8868554A"));

		// System.out.println(decodeThenUnescape("select --star from A --plus B"));
	}
