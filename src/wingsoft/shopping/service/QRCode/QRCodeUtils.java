package wingsoft.shopping.service.QRCode;
...
//      g.drawImage(img, 25, 55,60,50, null);  
    ...
    /*生成二维码，返回文件流 —— 吴斌*/
    public static BufferedImage CreateQRCode(String encodeddata, File destFile) throws IOException {  
        Qrcode qrcode = new Qrcode();  
        qrcode.setQrcodeErrorCorrect('M');  // 纠错级别（L 7%、M 15%、Q 25%、H 30%）和版本有关  
        qrcode.setQrcodeEncodeMode('B');      
        qrcode.setQrcodeVersion(7);     // 设置Qrcode包的版本  
...
//      g.drawImage(img, 25, 55,60,50, null);  
    ...
    public String CreateQRCode(String Ppath ,String encodeddata){
    	Date currentTime = new Date();
    	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmss");
    	String dateString = formatter.format(currentTime);
    	String FilePath = Ppath+"/QRCode/"+dateString+".png"; 
